...
![شکل ۲۱.۱ (بالا): قدرت تعامل (آمارهٔ H) برای هر ویژگی با تمام ویژگی‌های دیگر برای یک جنگل تصادفی که P(ماده) را پیش‌بینی می‌کند. (پایین): قدرت‌های تعامل دوسویه (آمارهٔ H) بین تودهٔ بدنی و سایر ویژگی‌ها.](images/fig-interaction-penguins-1.png)
