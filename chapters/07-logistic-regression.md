...
> اگر بخواهید نتیجه را در سطح احتمال تفسیر کنید، باید از روش‌های مستقل از مدل (model-agnostic)، مانند [نمودار وابستگی جزئی](#pdp)، استفاده کنید.
...
بسیاری از نقاط قوت و ضعف [مدل رگرسیون خطی](#limo) برای مدل رگرسیون لجستیک نیز صدق می‌کند.
