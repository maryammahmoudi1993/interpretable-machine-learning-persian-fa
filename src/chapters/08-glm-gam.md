...
**راه‌حل:** [مدل‌های خطی تعمیم‌یافته (GLM)](#glm).
...
**راه‌حل:** [افزودن جملات تعاملی](#lm-interact).
...
**راه‌حل‌ها:** [مدل‌های جمعی تعمیم‌یافته (GAM)؛ تبدیل ویژگی‌ها](#gam).
